...
import { JobsCommandableHttpServiceV1 } from '../services/version1/JobsCommandableHttpServiceV1';
...
export class JobsServiceFactory extends Factory{
    ...
    public static HttpServiceV1Descriptor = new Descriptor('service-jobs', 'service', 'commandable-http', '*', '1.0');
    ...
    constructor(){
        ...
        this.registerAsType(JobsServiceFactory.HttpServiceV1Descriptor, JobsCommandableHttpServiceV1);
    }
}